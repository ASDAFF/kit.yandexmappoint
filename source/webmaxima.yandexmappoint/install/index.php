...
class webmaxima_yandexmappoint extends CModule
{
    ...
    var $MODULE_ID = 'webmaxima.yandexmappoint'; // MODULE_ID должен быть именно здесь в __construct не подойдет т.к битрикс не пропустит на модерацию
    ...
    public function __construct()
    {
        ...
        $this->PARTNER_URI = 'http://www.web-maxima.ru/'; // url нашей компании
